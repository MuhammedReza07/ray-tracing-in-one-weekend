...
impl Vector4 {
    ...
    pub fn norm2(&self) -> f32 {
        self.value[0] * self.value[0] + self.value[1] * self.value[1] + self.value[2] * self.value[2] + self.value[3] * self.value[3]
    }

    pub fn norm(&self) -> f32 {
        f32::sqrt(self.value[0] * self.value[0] + self.value[1] * self.value[1] + self.value[2] * self.value[2] + self.value[3] * self.value[3])
    }
    ...
    pub fn dot(&self, rhs: Self) -> f32 {
        self.value[0] * rhs.value[0] + self.value[1] * rhs.value[1] + self.value[2] * rhs.value[2] + self.value[3] * rhs.value[3]
    }
...
impl ops::Add for Vector4 {
    ...
    fn add(self, rhs: Self) -> Self::Output {
        Self { value: [self.value[0] + rhs.value[0], self.value[1] + rhs.value[1], self.value[2] + rhs.value[2], self.value[3] + rhs.value[3]] }
    }
}
...
impl ops::Mul<f32> for Vector4 {
    ...
    fn mul(self, rhs: f32) -> Self::Output {
        Self { value: [self.value[0] * rhs, self.value[1] * rhs, self.value[2] * rhs, self.value[3] * rhs] }
    }
}
...
impl ops::Mul<Vector4> for f32 {
    ...
    fn mul(self, rhs: Vector4) -> Self::Output {
        Vector4 { value: [self * rhs.value[0], self * rhs.value[1], self * rhs.value[2], self * rhs.value[3]] }
    }
}
...
impl ops::Neg for Vector4 {
    ...
    fn neg(self) -> Self::Output {
        Self { value: [-self.value[0], -self.value[1], -self.value[2], -self.value[3]] }
    }
}
